...
class GoodsCategory(models.Model):
    ...
    code = models.CharField(default='', max_length=30, verbose_name='类型code', help_text='类别code')
...
class GoodsCategoryBrand(models.Model):
    ...
    品牌名
    """
    name = models.CharField(default='', max_length=30, verbose_name='品牌名', help_text='平排名')
...
class Goods(models.Model):
    ...
    商品
    """
    category = models.ForeignKey(GoodsCategory, verbose_name='商品目录', on_delete=models.CASCADE)
